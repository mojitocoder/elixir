defmodule Minesweeper.Coordinate do
    ...
    def columns(b) do
        b |> List.first |> String.graphemes |> Enum.count
    end
...
defmodule Minesweeper do
    ...
    def neighbours_of(%C{} = me, b) do
        [
            ...
            |> Enum.filter(fn c -> 0 <= c.row && c.row < C.rows(b) && 0 <= c.column && c.column <= C.columns(b) end)
    end

    def value_of(%C{} = me, b) do
        b |> Enum.at(me.row) |> String.graphemes |> Enum.at(me.column)
    end
